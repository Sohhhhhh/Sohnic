...
export const encodedTokenSchema = z
  .object({
...
export type EncodedToken = z.output<typeof encodedTokenSchema>;
export type SetPasswordBodyDto = z.output<typeof setPasswordBodySchema>;
